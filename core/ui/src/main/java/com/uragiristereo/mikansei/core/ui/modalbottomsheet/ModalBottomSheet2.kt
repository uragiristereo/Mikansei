...
/**
 * State of the [ModalBottomSheetLayout2] composable.
 *
...
class ModalBottomSheetState2(
    ...
    companion object {
        /**
         * The default [Saver] implementation for [ModalBottomSheetState2].
         */
        fun Saver(
            animationSpec: AnimationSpec<Float>,
            skipHalfExpanded: Boolean,
            confirmStateChange: (ModalBottomSheetValue) -> Boolean
        ): Saver<ModalBottomSheetState2, *> = Saver(
...
/**
 * Create a [ModalBottomSheetState2] and [remember] it.
 *
...
@Composable
@ExperimentalMaterialApi
fun rememberModalBottomSheetState2(
    initialValue: ModalBottomSheetValue,
    animationSpec: AnimationSpec<Float> = SwipeableDefaults.AnimationSpec,
    skipHalfExpanded: Boolean,
    confirmStateChange: (ModalBottomSheetValue) -> Boolean = { true }
...
fun rememberModalBottomSheetState2(
    ...
    animationSpec: AnimationSpec<Float> = SwipeableDefaults.AnimationSpec,
    confirmStateChange: (ModalBottomSheetValue) -> Boolean = { true }
): ModalBottomSheetState2 = rememberModalBottomSheetState2(
    initialValue = initialValue,
    animationSpec = animationSpec,
    skipHalfExpanded = false,
    confirmStateChange = confirmStateChange
...
fun ModalBottomSheetLayout2(
    ...
    sheetState: ModalBottomSheetState2 =
        rememberModalBottomSheetState2(ModalBottomSheetValue.Hidden),
        ...
        val dismissModifier = if (visible) {
            Modifier
                ...
                .semantics(mergeDescendants = true) {
                    contentDescription = "close_sheet"
...
/**
 * Contains useful Defaults for [ModalBottomSheetLayout2].
 */
object ModalBottomSheetDefaults {

    /**
     * The default elevation used by [ModalBottomSheetLayout2].
     */
    val Elevation = 16.dp

    /**
     * The default scrim color used by [ModalBottomSheetLayout2].
     */
