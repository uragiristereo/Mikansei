...
private fun ScaffoldLayout(
    ...
    SubcomposeLayout { constraints ->
        ...
        layout(layoutWidth, layoutHeight) {
            ...
            val snackbarOffsetFromBottom = when {
                snackbarHeight != 0 && bottomBarHeight == 0 -> snackbarHeight + (fabOffsetFromBottom ?: contentPadding.calculateBottomPadding().roundToPx())
                snackbarHeight != 0 -> snackbarHeight + (fabOffsetFromBottom ?: bottomBarHeight)
                else -> 0
            }
            ...
            innerPadding.apply {
                ...
                bottom = fabOffsetFromBottom?.toDp() ?: (bottomBarHeight.toDp() + contentPadding.calculateBottomPadding())
            }
