...
import com.uragiristereo.mikansei.core.ui.modalbottomsheet.navigation.BottomSheetNavigator.Destination
...
@Stable
class BottomSheetNavigatorSheetState(internal val sheetState: ModalBottomSheetState2) {
    /**
...
fun rememberBottomSheetNavigator(
    ...
    val sheetState = rememberModalBottomSheetState2(
...
class BottomSheetNavigator(
    internal val sheetState: ModalBottomSheetState2
