...
class AddToFavGroupViewModel(
    ...
    private val getCachedFavoriteGroupsUseCase: GetCachedFavoriteGroupsUseCase,
) : ViewModel() {
    ...
    private fun loadFavoriteGroups() {
        viewModelScope.launch {
            ...
            getCachedFavoriteGroupsUseCase.invoke().collect { result ->
                when (result) {
                    is Result.Success -> {
    ...
    private fun updateAndCacheFavoriteGroups(showLoading: Boolean) {
        ...
        viewModelScope.launch(context) {
            ...
            val result = getFavoriteGroupsUseCase.invoke(
                forceRefresh = true,
