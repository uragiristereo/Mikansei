package com.uragiristereo.mejiboard.data.source.danbooru.model

import com.uragiristereo.mejiboard.common.helper.NumberHelper
import com.uragiristereo.mejiboard.data.source.BooruSources
import com.uragiristereo.mejiboard.data.source.danbooru.model.post.DanbooruPost
import com.uragiristereo.mejiboard.data.source.danbooru.model.search.DanbooruSearch
import com.uragiristereo.mejiboard.data.source.danbooru.model.tag.DanbooruTag
...
fun List<DanbooruPost>.toPostList(): List<Post> {
    ...
    return this.map {
        ...
        Post(
            ...
            aspectRatio = NumberHelper.coerceAspectRatio(it.imageWidth, it.imageHeight),
        )
    }
}
...
fun List<DanbooruSearch>.toTagList(): List<Tag> {
    return this.mapIndexed { index, it ->
        Tag(
            ...
            count = it.postCount,
            countFmt = NumberHelper.convertToUnit(it.postCount),
