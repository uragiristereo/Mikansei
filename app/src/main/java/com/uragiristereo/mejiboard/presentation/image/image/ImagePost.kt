package com.uragiristereo.mejiboard.presentation.image.image
...
import com.uragiristereo.mejiboard.common.helper.ImageHelper
...
fun ImagePost(
    ...
    DisposableEffect(key1 = viewModel) {
        val resized = ImageHelper.resizeImage(post.originalImage)
